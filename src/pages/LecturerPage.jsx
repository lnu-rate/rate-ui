    ...
    <>
      <StyledStack>
        ...
        >
          ...
          <Box>
            <Typography variant="h4">{LECTURER_DATA.fullName}</Typography>
            <Link
            ...
            >
              <Typography variant="h6">{LECTURER_DATA.email}</Typography>
            </Link>
            <Box>
              <Typography
                variant="text"
              ...
              >
                <b>Посада: </b>
                {LECTURER_DATA.degree}, кафедрa оптоелектроніки та інформаційних
                технологій
              </Typography>
            </Box>
          </Box>
        ...
        {IS_SEMESTER_DONE && (
          ...
          >
            ...
            <Box sx={{ display: 'flex', flexDirection: 'column' }}>
              ...
              >
                <InfoIcon />
                Коментар вважається опціональним та ставити його можна за
                бажанням студента.
              </Typography>
            </Box>
            <Box sx={{ display: 'flex', justifyContent: 'space-between' }}>
              ...
              <FormControl sx={{ width: '30%' }}>
                ...
                <Select
                  ...
                  onChange={(e) => setMethodologicalSupport(e.target.value)}
                  sx={{
                    borderRadius: 2,
                  }}
                >
              ...
              <FormControl sx={{ width: '30%' }}>
                ...
                <Select
                  ...
                  onChange={(e) => setObjectivity(e.target.value)}
                  sx={{
                    borderRadius: 2,
                  }}
                >
