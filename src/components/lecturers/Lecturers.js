...
export const DEPARTMENTS = [
  ...
  {
    name: "Кафедра радіоелектронних і комп'ютерних систем",
    id: '123eqwrfdsASD',
    lecturers: [
      {
        id: '4',
  ...
  {
    name: "Кафедра радіофізики та комп'ютерних технологій",
    id: 'u7898OHJBNu',
    lecturers: [
      {
        id: '7',
  ...
  {
    name: 'Кафедра сенсорної та напівпровідникової електроніки',
    id: '09786tyuHLJBHy7',
    lecturers: [
      {
        id: '10',
