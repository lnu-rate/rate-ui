  ...
  return (
    <>
      ...
      >
        <Container maxWidth="xl">
          <Toolbar disableGutters>
            ...
            >
              <IconButton disableRipple onClick={handleOpenNavMenu}>
                <MenuIcon />
              </IconButton>
              <Menu
                id="menu-appbar"
            ...
            >
              ...
              {localStorage.getItem('role') === 'admin' && (
                <Button
                  ...
                  onClick={() => setRegisterOpenModal(!isRegisterModalOpen)}
                >
      ...
      >
        <Box>
          <RegisterForm
            handleCloseModal={() => setRegisterOpenModal(!isRegisterModalOpen)}
          />
        </Box>
      </Modal>
    </>
